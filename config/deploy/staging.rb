...
server '104.236.71.92', user: fetch(:user), roles: %w{web app}

# PATHS
set :deploy_to, "/var/www/staging.hotairgame.com"
set :log_path, "/var/log/#{fetch:application}/staging.hotairgame.com-debug.log"
